...
public class MenuJuego extends javax.swing.JFrame {
    ...
    public MenuJuego(Jugador J) {
        ...
        juego = new Juego(new Comandos(),new Excepciones("")); 
        juego.setJugador(J);
        ...
        jFrame1.setIconImage(new ImageIcon("src/images/icono.png").getImage());
        ...
        ImageIcon dDif = new ImageIcon("src/images/dialogo1.jpg");
